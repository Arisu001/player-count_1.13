...
tellraw @a [{"text": "═════════[ ", "color": "#19df5", "bold": true}, {"text": "Player Count", "color": "light_purple"}, {"text": " ]═════════"}]
tellraw @a ""
tellraw @a [{"text": "Version", "color": "gray"}, {"text": ": ", "color": "yellow"}, {"text": "1.4.7", "color": "aqua"}]
